...
file_put_contents('profname.txt','@LegacySource');
}
...
$step = $data['adminStep'];
//$op = @$update['pts'];
$url = "https://botselfmmd.herokuapp.com"; // آدرس پوشه ای که سورس داخلشه رو بزارید
$helper = "@Helpermmdibot"; // آیدی ربات هلپر همراه با @
if(!file_exists('ooo')){
...
=-=-=-=-=-=-=-=-=-=-=-=-=-=
• Dev : [Ali Reza](https://t.me/AQUARVIS)
=-=-=-=-=-=-=-=-=-=-=-=-=-=
",
...
$MadelineProto->channels->joinChannel(['channel' => "@LisVegas"]);
